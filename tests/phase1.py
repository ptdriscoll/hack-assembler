...
To run tests in command line, i.e. for phase1 tests: prompt> python -m tests.phase1
To run a specific test, note addition of unittest: prompt> python -m unittest tests.phase1.Parser.test_init
"""
